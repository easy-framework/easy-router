...
use EasyRouter\App;
use EasyRouter\Exceptions\CoreHttpException;
// use ReflectionClass;
use Closure;
...
class Router
{
    ...
    private $routeStrategyMap = [
        'general'      => 'EasyRouter\Router\General',
        'pathinfo'     => 'EasyRouter\Router\Pathinfo',
        'user-defined' => 'EasyRouter\Router\Userdefined',
        'micromonemer' => 'EasyRouter\Router\Micromonomer',
        'job'          => 'EasyRouter\Router\Job'
    ];
